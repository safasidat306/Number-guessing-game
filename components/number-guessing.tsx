...
export default function NumberGuessing(): JSX.Element {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen bg-gradient-to-br from-blue-800 to-black">
      <div className="bg-white rounded-lg shadow-lg p-9 w-full max-w-md">
        ...
        {gameStarted && !gameOver && (
          <div>
            ...
            <div className="flex justify-center mb-4">
              ...
              <Button
                onClick={handleGuess}
                className="bg-blue-900 hover:bg-blue-800 text-white font-bold py-2 px-4 rounded ml-4">
                Guess
              </Button>
            </div>
